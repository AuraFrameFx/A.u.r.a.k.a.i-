...
| [🔄 **Workflow Guide**](../../../../../../Aurakai-navi/.github/AGENT_WORKFLOW_GUIDE.md)      | GitHub Actions patterns              |
...
<details>
<summary>🏗️ <strong>Core Modules</strong></summary>

- [🏗️ **Core Module**](./modules/CORE_MODULE.md) - Foundation module
- [🚀 **Feature Module**](./modules/FEATURE_MODULE.md) - Main features
- [📱 **App Module**](./modules/APP_MODULE.md) - Application entry point

</details>

<details>
<summary>🎨 <strong>UI Modules</strong></summary>

- [🌈 **ColorBlendr**](./modules/COLORBLENDR_MODULE.md) - Color management
- [🖌️ **Collab Canvas**](./modules/COLLAB_CANVAS_MODULE.md) - Collaborative drawing
- [🧪 **Sandbox UI**](./modules/SANDBOX_UI_MODULE.md) - Experimental UI

</details>

<details>
<summary>🔧 <strong>Utility Modules</strong></summary>

- [📡 **DataVein Oracle Native**](./modules/DATAVEIN_ORACLE_MODULE.md) - Native integration
- [☁️ **Oracle Drive Integration**](./modules/ORACLE_DRIVE_MODULE.md) - Cloud storage
- [🔒 **Secure Communication**](./modules/SECURE_COMM_MODULE.md) - Encrypted comms
- [🛠️ **ROM Tools**](./modules/ROMTOOLS_MODULE.md) - ROM manipulation

</details>

<details>
<summary>📊 <strong>Testing Modules</strong></summary>

- [⚡ **Benchmark**](./modules/BENCHMARK_MODULE.md) - Performance testing
- [📷 **Screenshot Tests**](./modules/SCREENSHOT_TESTS_MODULE.md) - Visual testing
