...
if GENAI_AVAILABLE and GOOGLE_API_KEY:
    ...
    logger.debug("GOOGLE_API_KEY not set - Gemini unavailable")
else:
    logger.debug("Google GenAI SDK not available - install google-genai")
...
if ANTHROPIC_AVAILABLE and ANTHROPIC_API_KEY:
    ...
    logger.debug("Anthropic SDK not available - install anthropic")
